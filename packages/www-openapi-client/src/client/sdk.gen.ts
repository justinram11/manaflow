...
/**
 * Create a snapshot of a running Firecracker VM
 */
...
/**
 * List available Firecracker snapshots
 */
export const getApiSandboxesFirecrackerSnapshots = <ThrowOnError extends boolean = false>(options?: Options<GetApiSandboxesFirecrackerSnapshotsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiSandboxesFirecrackerSnapshotsResponses, GetApiSandboxesFirecrackerSnapshotsErrors, ThrowOnError>({
 ...
 */
export const deleteApiSandboxesFirecrackerSnapshotsBySnapshotId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdResponses, DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdErrors, ThrowOnError>({
 ...
 */
export const postApiSandboxesFirecrackerByIdPause = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesFirecrackerByIdPauseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesFirecrackerByIdPauseResponses, PostApiSandboxesFirecrackerByIdPauseErrors, ThrowOnError>({
 ...
 */
export const postApiSandboxesFirecrackerByIdResume = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesFirecrackerByIdResumeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesFirecrackerByIdResumeResponses, PostApiSandboxesFirecrackerByIdResumeErrors, ThrowOnError>({
 ...
 */
export const getApiSandboxesFirecrackerByIdStatus = <ThrowOnError extends boolean = false>(options: Options<GetApiSandboxesFirecrackerByIdStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiSandboxesFirecrackerByIdStatusResponses, GetApiSandboxesFirecrackerByIdStatusErrors, ThrowOnError>({
...
/**
 * Destroy a Firecracker VM (stop and delete all files)
 */
export const postApiSandboxesFirecrackerByIdDestroy = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesFirecrackerByIdDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesFirecrackerByIdDestroyResponses, PostApiSandboxesFirecrackerByIdDestroyErrors, ThrowOnError>({
 ...
 */
export const postApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPaused = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedResponses, PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedErrors, ThrowOnError>({
 ...
 */
export const postApiSandboxesFirecrackerTaskRunsByTaskRunIdResume = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeResponses, PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeErrors, ThrowOnError>({
