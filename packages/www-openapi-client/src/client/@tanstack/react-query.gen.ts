...
export const getApiResourceProvidersQueryKey = (options: Options<GetApiResourceProvidersData>) => createQueryKey('getApiResourceProviders', options);

/**
 * List resource providers for team
 */
export const getApiResourceProvidersOptions = (options: Options<GetApiResourceProvidersData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiResourceProviders({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiResourceProvidersQueryKey(options)
    });
};
 ...
 */
export const postApiResourceProvidersMutation = (options?: Partial<Options<PostApiResourceProvidersData>>): UseMutationOptions<PostApiResourceProvidersResponse, PostApiResourceProvidersError, Options<PostApiResourceProvidersData>> => {
    const mutationOptions: UseMutationOptions<PostApiResourceProvidersResponse, PostApiResourceProvidersError, Options<PostApiResourceProvidersData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiResourceProviders({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Deregister resource provider
 */
export const deleteApiResourceProvidersByIdMutation = (options?: Partial<Options<DeleteApiResourceProvidersByIdData>>): UseMutationOptions<DeleteApiResourceProvidersByIdResponse, DeleteApiResourceProvidersByIdError, Options<DeleteApiResourceProvidersByIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiResourceProvidersByIdResponse, DeleteApiResourceProvidersByIdError, Options<DeleteApiResourceProvidersByIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteApiResourceProvidersById({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiResourceProvidersByIdQueryKey = (options: Options<GetApiResourceProvidersByIdData>) => createQueryKey('getApiResourceProvidersById', options);

/**
 * Get resource provider details
 */
export const getApiResourceProvidersByIdOptions = (options: Options<GetApiResourceProvidersByIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiResourceProvidersById({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiResourceProvidersByIdQueryKey(options)
    });
};
 ...
 */
export const patchApiResourceProvidersByIdMutation = (options?: Partial<Options<PatchApiResourceProvidersByIdData>>): UseMutationOptions<PatchApiResourceProvidersByIdResponse, PatchApiResourceProvidersByIdError, Options<PatchApiResourceProvidersByIdData>> => {
    const mutationOptions: UseMutationOptions<PatchApiResourceProvidersByIdResponse, PatchApiResourceProvidersByIdError, Options<PatchApiResourceProvidersByIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await patchApiResourceProvidersById({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Allocate resource provider for a workspace
 */
export const postApiResourceProvidersByIdAllocateMutation = (options?: Partial<Options<PostApiResourceProvidersByIdAllocateData>>): UseMutationOptions<PostApiResourceProvidersByIdAllocateResponse, PostApiResourceProvidersByIdAllocateError, Options<PostApiResourceProvidersByIdAllocateData>> => {
    const mutationOptions: UseMutationOptions<PostApiResourceProvidersByIdAllocateResponse, PostApiResourceProvidersByIdAllocateError, Options<PostApiResourceProvidersByIdAllocateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiResourceProvidersByIdAllocate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiResourceProvidersAllocationsByAllocationIdReleaseMutation = (options?: Partial<Options<PostApiResourceProvidersAllocationsByAllocationIdReleaseData>>): UseMutationOptions<PostApiResourceProvidersAllocationsByAllocationIdReleaseResponse, PostApiResourceProvidersAllocationsByAllocationIdReleaseError, Options<PostApiResourceProvidersAllocationsByAllocationIdReleaseData>> => {
    const mutationOptions: UseMutationOptions<PostApiResourceProvidersAllocationsByAllocationIdReleaseResponse, PostApiResourceProvidersAllocationsByAllocationIdReleaseError, Options<PostApiResourceProvidersAllocationsByAllocationIdReleaseData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiResourceProvidersAllocationsByAllocationIdRelease({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Proxy MCP JSON-RPC request to Mac daemon
 */
export const postApiResourceProvidersAllocationsByAllocationIdMcpMutation = (options?: Partial<Options<PostApiResourceProvidersAllocationsByAllocationIdMcpData>>): UseMutationOptions<PostApiResourceProvidersAllocationsByAllocationIdMcpResponse, PostApiResourceProvidersAllocationsByAllocationIdMcpError, Options<PostApiResourceProvidersAllocationsByAllocationIdMcpData>> => {
    const mutationOptions: UseMutationOptions<PostApiResourceProvidersAllocationsByAllocationIdMcpResponse, PostApiResourceProvidersAllocationsByAllocationIdMcpError, Options<PostApiResourceProvidersAllocationsByAllocationIdMcpData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiResourceProvidersAllocationsByAllocationIdMcp({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
