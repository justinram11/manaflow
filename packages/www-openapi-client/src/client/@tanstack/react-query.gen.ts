...
export const getApiTeamSettingsQueryKey = (options: Options<GetApiTeamSettingsData>) => createQueryKey('getApiTeamSettings', options);

/**
 * Get team settings
 */
export const getApiTeamSettingsOptions = (options: Options<GetApiTeamSettingsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiTeamSettings({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiTeamSettingsQueryKey(options)
    });
};
 ...
 */
export const patchApiTeamSettingsMutation = (options?: Partial<Options<PatchApiTeamSettingsData>>): UseMutationOptions<PatchApiTeamSettingsResponse, PatchApiTeamSettingsError, Options<PatchApiTeamSettingsData>> => {
    const mutationOptions: UseMutationOptions<PatchApiTeamSettingsResponse, PatchApiTeamSettingsError, Options<PatchApiTeamSettingsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await patchApiTeamSettings({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
