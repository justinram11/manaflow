...
export const getApiSandboxesFirecrackerSnapshotsQueryKey = (options?: Options<GetApiSandboxesFirecrackerSnapshotsData>) => createQueryKey('getApiSandboxesFirecrackerSnapshots', options);

/**
 * List available Firecracker snapshots
 */
export const getApiSandboxesFirecrackerSnapshotsOptions = (options?: Options<GetApiSandboxesFirecrackerSnapshotsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiSandboxesFirecrackerSnapshots({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiSandboxesFirecrackerSnapshotsQueryKey(options)
    });
};
 ...
 */
export const deleteApiSandboxesFirecrackerSnapshotsBySnapshotIdMutation = (options?: Partial<Options<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdData>>): UseMutationOptions<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdResponse, DefaultError, Options<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdResponse, DefaultError, Options<DeleteApiSandboxesFirecrackerSnapshotsBySnapshotIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteApiSandboxesFirecrackerSnapshotsBySnapshotId({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiSandboxesFirecrackerByIdPauseMutation = (options?: Partial<Options<PostApiSandboxesFirecrackerByIdPauseData>>): UseMutationOptions<PostApiSandboxesFirecrackerByIdPauseResponse, DefaultError, Options<PostApiSandboxesFirecrackerByIdPauseData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesFirecrackerByIdPauseResponse, DefaultError, Options<PostApiSandboxesFirecrackerByIdPauseData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesFirecrackerByIdPause({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiSandboxesFirecrackerByIdResumeMutation = (options?: Partial<Options<PostApiSandboxesFirecrackerByIdResumeData>>): UseMutationOptions<PostApiSandboxesFirecrackerByIdResumeResponse, DefaultError, Options<PostApiSandboxesFirecrackerByIdResumeData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesFirecrackerByIdResumeResponse, DefaultError, Options<PostApiSandboxesFirecrackerByIdResumeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesFirecrackerByIdResume({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiSandboxesFirecrackerByIdStatusQueryKey = (options: Options<GetApiSandboxesFirecrackerByIdStatusData>) => createQueryKey('getApiSandboxesFirecrackerByIdStatus', options);

/**
 * Get Firecracker VM status
 */
export const getApiSandboxesFirecrackerByIdStatusOptions = (options: Options<GetApiSandboxesFirecrackerByIdStatusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiSandboxesFirecrackerByIdStatus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiSandboxesFirecrackerByIdStatusQueryKey(options)
    });
};
 ...
 */
export const postApiSandboxesFirecrackerByIdDestroyMutation = (options?: Partial<Options<PostApiSandboxesFirecrackerByIdDestroyData>>): UseMutationOptions<PostApiSandboxesFirecrackerByIdDestroyResponse, DefaultError, Options<PostApiSandboxesFirecrackerByIdDestroyData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesFirecrackerByIdDestroyResponse, DefaultError, Options<PostApiSandboxesFirecrackerByIdDestroyData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesFirecrackerByIdDestroy({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedMutation = (options?: Partial<Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedData>>): UseMutationOptions<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedResponse, DefaultError, Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedResponse, DefaultError, Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPausedData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesFirecrackerTaskRunsByTaskRunIdIsPaused({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeMutation = (options?: Partial<Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeData>>): UseMutationOptions<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeResponse, DefaultError, Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeResponse, DefaultError, Options<PostApiSandboxesFirecrackerTaskRunsByTaskRunIdResumeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesFirecrackerTaskRunsByTaskRunIdResume({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
