...
func typeText(_ text: String) throws {
    ...
    try postKey(keyCode: 0x37, keyDown: true)
    try postKey(keyCode: 0x09, keyDown: true, flags: .maskCommand)
...
func pressButton(_ button: String) throws {
    ...
    case "home":
        try postKey(keyCode: 0x37, keyDown: true)
        try postKey(keyCode: 0x38, keyDown: true, flags: [.maskCommand, .maskShift])
        try postKey(keyCode: 0x04, keyDown: true, flags: [.maskCommand, .maskShift])
    ...
    case "lock":
        try postKey(keyCode: 0x37, keyDown: true)
        try postKey(keyCode: 0x25, keyDown: true, flags: .maskCommand)
...
do {
    ...
    case "button":
        ...
        printJson(["success": true, "action": "button"])
    default:
