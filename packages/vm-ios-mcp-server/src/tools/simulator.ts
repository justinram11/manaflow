...
const iosSimulatorShutdown: ToolHandler = async (_params, allocationId) => {
  ...
  try {
    exec(`xcrun simctl shutdown "${alloc.simulatorUdid}"`);
    return { success: true };
  } catch (error) {
...
const iosSimulatorTerminate: ToolHandler = async (params, allocationId) => {
  ...
  try {
    exec(`xcrun simctl terminate "${alloc.simulatorUdid}" "${params.bundleId}"`);
    return { success: true };
  } catch (error) {
    return { error: String(error) };
  }
...
const iosSimulatorErase: ToolHandler = async (_params, allocationId) => {
  ...
  try {
    exec(`xcrun simctl erase "${alloc.simulatorUdid}"`);
    return { success: true };
  } catch (error) {
    return { error: String(error) };
  }
...
const iosSimulatorSetAppearance: ToolHandler = async (params, allocationId) => {
  ...
  try {
    exec(`xcrun simctl ui "${alloc.simulatorUdid}" appearance ${appearance}`);
    return { success: true };
  } catch (error) {
    return { error: String(error) };
  }
