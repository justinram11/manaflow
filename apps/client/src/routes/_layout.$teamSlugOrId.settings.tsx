...
function GitLabIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M23.955 13.587l-1.342-4.135-2.664-8.189c-.135-.423-.73-.423-.867 0L16.418 9.45H7.582L4.919 1.263C4.783.84 4.185.84 4.05 1.263L1.386 9.45.044 13.587a.924.924 0 00.331 1.023L12 23.054l11.625-8.443a.92.92 0 00.33-1.024" />
    </svg>
  );
}
...
function SettingsComponent() {
  ...
  const hasChanges = () => {
    ...
    // Check all required API keys for changes (including GITHUB_PAT, CLAUDE_CREDENTIALS_JSON)
    const apiKeysChanged = [...apiKeys, ...EXTRA_KEYS].some((keyConfig) => {
  ...
  const saveApiKeys = async () => {
    ...
    try {
      ...
      for (const key of [...apiKeys, ...EXTRA_KEYS]) {
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-neutral-950 rounded-lg border border-neutral-200 dark:border-neutral-800">
              <div className="px-4 py-3 border-b border-neutral-200 dark:border-neutral-800">
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                  Used for cloning private repos and GitHub API access inside
                  sandboxes. Falls back to GitHub OAuth if not set.
                </p>
              </div>
              <div className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0 space-y-2">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                          Needs <code className="px-1 py-0.5 bg-neutral-100 dark:bg-neutral-800 rounded text-[11px]">repo</code> scope for private repositories
                        </p>
                      </div>
                      <a
                    ...
                    <div className="md:w-[min(100%,480px)]">
                      <div className="relative">
                        <input
                          type={showKeys.GITHUB_PAT ? "text" : "password"}
                          id="GITHUB_PAT"
                          value={apiKeyValues.GITHUB_PAT || ""}
                          onChange={(e) =>
                            handleApiKeyChange("GITHUB_PAT", e.target.value)
                          }
                        ...
                        <button
                          type="button"
                          onClick={() => toggleShowKey("GITHUB_PAT")}
                      ...
                      {originalApiKeyValues.GITHUB_PAT && (
            ...
            <div className="bg-white dark:bg-neutral-950 rounded-lg border border-neutral-200 dark:border-neutral-800">
              <div className="px-4 py-3 border-b border-neutral-200 dark:border-neutral-800">
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                  Used for cloning private GitLab repos inside sandboxes.
                </p>
              </div>
              <div className="p-4">
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 bg-neutral-100 dark:bg-neutral-800 rounded-lg flex items-center justify-center flex-shrink-0">
                    <GitLabIcon className="w-4.5 h-4.5 text-neutral-700 dark:text-neutral-300" />
                  </div>
                  <div className="flex-1 min-w-0 space-y-2">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                          Needs <code className="px-1 py-0.5 bg-neutral-100 dark:bg-neutral-800 rounded text-[11px]">read_repository</code> scope for private repositories
                        </p>
                      </div>
                      <a
                    ...
                    <div className="md:w-[min(100%,480px)]">
                      <div className="relative">
                        <input
                          type={showKeys.GITLAB_PAT ? "text" : "password"}
                          id="GITLAB_PAT"
                          value={apiKeyValues.GITLAB_PAT || ""}
                          onChange={(e) =>
                            handleApiKeyChange("GITLAB_PAT", e.target.value)
                          }
                          className="w-full px-3 py-2 pr-10 border border-neutral-300 dark:border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 font-mono text-xs"
                        ...
                        <button
                          type="button"
                          onClick={() => toggleShowKey("GITLAB_PAT")}
                          className="absolute inset-y-0 right-0 pr-3 flex items-center text-neutral-500"
                        >
                          {showKeys.GITLAB_PAT ? (
                            <svg
                      ...
                      {originalApiKeyValues.GITLAB_PAT && (
                        <div className="flex items-center gap-1 mt-1">
                          <svg
                            className="w-3 h-3 text-green-500 dark:text-green-400"
                            fill="none"
