  ...
  return (
    <div className="rounded-md border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 overflow-hidden">
      <Accordion
        ...
        className="px-0"
        defaultExpandedKeys={showFirecrackerOption ? ["advanced-options"] : []}
        itemClasses={{
          trigger:
      ...
      >
        ...
        >
          <div className="space-y-4 pt-1.5">
            {/* Provider selection — only visible in local auth mode */}
            {showFirecrackerOption && onProviderChange && (
              <RadioGroup
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                            Cloud-hosted sandbox with managed infrastructure
                          </p>
                        </div>
                        <span
            ...
            {/* Machine size — only shown for Morph provider */}
            {selectedProvider === "morph" && (
              <RadioGroup
